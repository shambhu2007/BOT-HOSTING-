...
def create_send_command_menu():
    ...
    markup.row(types.InlineKeyboardButton('🔙 Back', callback_data='sendcmd_back_to_keyboard'))
    return markup
...
def handle_callbacks(call):
    ...
    try:
        ...
        elif data == 'sendcmd_back_to_keyboard': sendcmd_back_to_keyboard_callback(call)
...
def sendcmd_back_to_keyboard_callback(call):
    bot.answer_callback_query(call.id)
    try:
